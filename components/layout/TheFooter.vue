      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div class="lg:col-span-1">
          ...
          <div class="flex gap-3 mt-6">
            ...
            <a href="https://discord.gg/EPYGKa3Rkz" target="_blank" rel="noopener" class="w-10 h-10 rounded-lg bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center text-zinc-400 hover:text-zinc-100 transition">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li v-for="link in footerLinks.product" :key="link.path">
              <NuxtLink :to="link.path" class="text-sm text-zinc-400 hover:text-zinc-100 transition">
                {{ link.label }}
              </NuxtLink>
            </li>
          </ul>
