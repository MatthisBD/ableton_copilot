...
## 5. **UPDATE DOCS**: always keep docs claude.md up to date when medium / big features is added

- **First check claude.md, backend/claude.md, frontend/claude.md, ml-service/claude.md**
- Wheen up to date with all the changes that need to be updated
