        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="space-y-6">
            <Card class="p-6">
              ...
              <Button variant="outline" class="w-full" @click="openGithubIssue('bug')">
            ...
            <Card class="p-6">
              ...
              <Button variant="outline" class="w-full" @click="openGithubIssue('feature')">
            ...
            <Card class="p-6">
              ...
              <div class="space-y-4">
                <a
                  href="mailto:contact@abletoncopilot.com"
                ...
                >
                  ...
                  <div>
                    <p class="text-sm font-medium text-zinc-100">Twitter / X</p>
                    <p class="text-sm">@abletoncopilot</p>
                  </div>
                </a> -->
              </div>
            </Card>
